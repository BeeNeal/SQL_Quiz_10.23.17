...
SELECT o.ID, o.status, o.order_total FROM customers AS c JOIN orders AS o ON c.ID = o.customer_ID WHERE c.ID = 100;
...
SELECT o.id, o.status, o.order_total FROM orders AS o JOIN customers AS c ON o.customer_id =  c.ID WHERE c.email = 'pclark74@gmail.com';